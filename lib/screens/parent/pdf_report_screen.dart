      ...
      pw.MultiPage(
        ...
        header: (context) => pw.Column(
          ...
          children: [
            ...
            pw.Text('Weekly Report - $childName',
                style: pw.TextStyle(
                    fontSize: 16,
                    fontWeight: pw.FontWeight.bold,
        ...
        build: (context) => [
          ...
          pw.Container(
            ...
            child: pw.Row(
              ...
              children: [
                _pdfStatBox('Total Distance',
                    '${totalDistance.toStringAsFixed(1)} km'),
                _pdfStatBox('Moving Time',
                    '${totalMovingMinutes ~/ 60}h ${totalMovingMinutes % 60}m'),
                _pdfStatBox('Max Speed',
          ...
          pw.SizedBox(height: 8),
          pw.Text(
            'Generated by Family Safety App on ${DateFormat('dd/MM/yyyy HH:mm').format(DateTime.now())}',
            style: const pw.TextStyle(
