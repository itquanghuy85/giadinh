...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'permission_denied_msg': 'This permission was denied. Please open Settings and enable it manually.',
      ...
      'delete_account_confirm': 'This will permanently delete all your data and unlink your account. This action cannot be undone.',
      'delete_data': 'Delete Data',
      'delete_data_desc': 'Delete all your data and unlink account',
    ...
    'vi': {
      ...
      'permission_denied_msg': 'Quyền này đã bị từ chối. Vui lòng mở Cài đặt và bật thủ công.',
      ...
      'exit_app_confirm': 'Bạn có chắc muốn thoát ứng dụng?',
      'exit': 'Thoát',
      'delete_account': 'Xóa tài khoản',
      'delete_account_confirm': 'Thao tác này sẽ xóa vĩnh viễn tất cả dữ liệu và hủy liên kết tài khoản. Không thể hoàn tác.',
      'delete_data': 'Xóa dữ liệu',
      'delete_data_desc': 'Xóa tất cả dữ liệu và hủy liên kết tài khoản',
      ...
      'spouse_report': 'Báo cáo cho vợ/chồng',
